...
import ContentSpecialawards from '../content/contentSpecialawards'
...
class Specialawards extends Component {
  constructor(props){
    super(props)
    this.state ={
...
export default connect(mapStateProps)(Specialawards);
