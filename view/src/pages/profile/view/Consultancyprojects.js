...
import ContentConsultancyprojects from '../content/contentConsultancyprojects'
...
class Consultancyprojects extends Component {
  constructor(props){
    super(props)
    this.state ={
...
export default connect(mapStateProps)(Consultancyprojects);
