...
import ContentFacultymobilityprog from '../content/contentFacultymobilityprog'
...
class Facultymobilityprog extends Component {
  constructor(props){
    super(props)
    this.state ={
...
export default connect(mapStateProps)(Facultymobilityprog);
