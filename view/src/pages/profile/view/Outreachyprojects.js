...
import ContentOutreachyprojects from '../content/contentOutreachyprojects'
...
class Outreachyprojects extends Component {
  constructor(props){
    super(props)
    this.state ={
...
export default connect(mapStateProps)(Outreachyprojects);
